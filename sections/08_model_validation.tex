...
\begin{itemize}
    ...
    \item \highlight[algorithm-color]{$p\ped{err} \leq P_{(n)} \color{gray} \text{ c.f. scr. (6.19)}$}
        $\overset{n\to\infty}{\to} 0$ \enspace if\enspace \highlight[algorithm-color]{$\frac{\log m}{\log\abs{\mathcal C}} < I$}\\
